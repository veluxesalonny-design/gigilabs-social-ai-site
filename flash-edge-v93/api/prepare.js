...
import { baseRpc as rpc, RPC_POLICY, sanitizeRpcError } from './rpc.js';
...
async function receiverState(receiver,from,borrow){
  ...
  const names=['owner','paused','maxBorrowRaw','authorizedQuote','aavePool','uniV2Router','sushiV2Router','uniV3Factory','uniV3Router','aeroFactoryRegistry','aeroClassicFactory','aeroClassicRouter','aeroClFactory','aeroClRouter'];
  const vals=await mapLimit(names,3,n=>call(receiver,viewAbi,n));
